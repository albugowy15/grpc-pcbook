...
// Search laptop is a server-streaming RPC to search for laptops
...
// RateLaptop is a bi-directional streaming RPC that allows client to rate a stream of laptops
